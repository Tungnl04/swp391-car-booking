...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/booking-style.css">
</head>
...
%>
    ...
    <nav class="bk-sidebar-nav">
        <a href="${pageContext.request.contextPath}/home" class="bk-sidebar-link ${_cp == '/home' ? 'active' : ''}">
        ...
        <c:if test="${sessionScope.currentUser != null}">
            ...
            <c:if test="${sessionScope.currentUser.role == 'STAFF' || sessionScope.currentUser.role == 'ADMIN'}">
                ...
                <a href="${pageContext.request.contextPath}/vehicles/manage" class="bk-sidebar-link">
                    <span class="material-symbols-outlined">garage</span> Quản lý xe
                </a>
                <a href="${pageContext.request.contextPath}/contracts" class="bk-sidebar-link">
                    <span class="material-symbols-outlined">description</span> Hợp đồng
                </a>
                <a href="${pageContext.request.contextPath}/handovers" class="bk-sidebar-link">
                    <span class="material-symbols-outlined">key</span> Giao xe
                </a>
                <a href="${pageContext.request.contextPath}/returns" class="bk-sidebar-link">
                    <span class="material-symbols-outlined">keyboard_return</span> Nhận lại xe
                </a>
                <a href="${pageContext.request.contextPath}/reports/revenue" class="bk-sidebar-link">
...
<div class="bk-main">
    ...
    <header class="bk-header">
        <div class="bk-header-search">
            ...
            <input type="text" placeholder="Tìm kiếm đặt xe...">
        </div>
